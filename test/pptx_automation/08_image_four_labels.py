...
if __name__ == '__main__':
    ppt_al = PowerPointAutoLabel("재물조사표_four_labels.pptx")
    ...
    for i, row in df.iterrows():
        ...
        page = i // 4
        label_idx = (i % 4) + 1
        ppt_al.change_text(page, {f"product_name_{label_idx}": row["product_name"]}, 32)
        ppt_al.change_text(page, {f"model_no_{label_idx}": row["model_no"]}, 20)

    ppt_al.save("[Auto]재물조사표_1400_for_with_image.pptx")
